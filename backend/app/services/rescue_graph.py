...
def run_rescue_graph(user_id: str, target_commitment_id: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    for step in (load_rescue_context, diagnose_failure_mode, calculate_rescue_feasibility, generate_rescue_options, validate_rescue_plan, persist_rescue_proposals, emit_trace):
